...
class TestCitation:
    ...
    def test_citation_equality(self):
        ...
        citation1 = Citation(
            url="https://example.com", title="Test", start_index=0, end_index=10
        )
        citation2 = Citation(
            url="https://example.com", title="Test", start_index=0, end_index=10
        )
    ...
    def test_citation_length_property(self):
        ...
        citation = Citation(
            url="https://example.com", title="Test", start_index=100, end_index=150
        )
...
class TestSource:
    ...
    def test_create_web_source(self):
        ...
        source = Source(url="https://techcrunch.com/article", type="web")
    ...
    def test_create_special_source(self):
        ...
        source = Source(url="oai-weather://london", type="oai-weather")
...
class TestSearchError:
    ...
    def test_create_basic_error(self):
        ...
        error = SearchError(code="API_ERROR", message="Something went wrong")
    ...
    def test_error_string_representation(self):
        ...
        error = SearchError(code="TEST_ERROR", message="Test message")
